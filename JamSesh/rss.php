...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
  <channel>
    ...
    <atom:link href="http://localhost/mattdaley-php/JamSesh/single.php?post_id=<?php echo $row['post_id']; ?>" rel="self" type="application/rss+xml" />
    <?php while ($row = $result->fetch_assoc()) { ?>
    <item>
      <title><?php echo $row['title']; ?></title>
      <link>http://localhost/mattdaley-php/JamSesh/single.php?post_id=<?php echo $row['post_id']; ?></link>
      <guid>http://localhost/mattdaley-php/JamSesh/single.php?post_id=<?php echo $row['post_id']; ?></guid>
